...
public final class Utilities {
    ...
    static int[] sLoc0 = new int[2];  // remove not used variables
    ...
    // Seems you need a icon/bitmap factory to set icon width/height, and
    // create a bitmap.
    // extra related codes to a separate file
